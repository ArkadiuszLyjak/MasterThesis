...
public class TransformerTypeEntity extends BaseEntity {
   //    id  //id– numer pozycji katalogowej
    ...
    Double nominalPower;  //nominal_power – moc znamionowa [kva]
    Double nominalUpperVoltage;  //nominal_upper_voltage – napięcie znamionowe górne [kv]
    Double nominalLowerVoltage;  //nominal_lower_voltage – napięcie znamionowe dolne kv]
    Double voltageIncreaseRange;
    Double voltageDecreaseRange;
    Double noOfAdjustmentRange;
    Double connectionGroup;
    Double loadPowerLoss; //load_power_loss – straty obciążeniowe czynne [kw]
    Double activeIdleLoss; //active_idle_loss – straty jałowe czynne [kw]
    Double idleCurrent;
    Double shortingVoltage; //shorting_voltage – napięcie zwarcia [%]
    Double zeroResistance;
    Double zeroReaktance;
